...
const FifthSection = () => {
  ...
  //
  const [productLength, setProductLength] = useState(typeOne.length);
  useEffect(() => {
        ...
        <div className="mainDiv">
          <div className="jwMenu">
            ...
            <div className="body">
              <ul>
                <li>
                  <Link to={"/products"}>Awesome Rings</Link>
                </li>
                <li>
                  <Link to={"/products"}>Hot Earrings</Link>
                </li>
                <li>
                  <Link to={"/products"}>Jewelry Sets</Link>
                </li>
                <li>
                  <Link to={"/products"}>Beads Jewelry</Link>
                </li>
                <li>
                  <Link to={"/products"}>Men's Watches</Link>
                </li>
                <li>
                  <Link to={"/products"}>Women’s Watches</Link>
                </li>
                <li>
                  <Link to={"/products"}>Popular Bracelets</Link>
                </li>
                <li>
                  <Link to={"/products"}>Pendant Necklaces</Link>
                </li>
                <li>
                  <Link to={"/products"}>Children's Watches</Link>
                </li>
              </ul>
            </div>
          </div>
